	...
	<div id="wrapper">
		...
		<div class="content">
			...
			<div class="post">
				...
				<hr>
				<br>
				<h3>UPDATE A REVIEW RATING</h3>
				
				
				<?php
					$link = mysqli_connect("localhost", "root", "", "bookreviews");
					
					print "<form method=\"POST\" action=\"updateReview2.php\">

						Review ID: <input type=\"text\" name=\"id\">
						<br>
						
						New Rating: <input type=\"radio\" name=\"rating\" value=\"5 Stars\"> 5 Stars
