		...
		<div class="content">
			...
			<div class="post">
				...
				<?php
					...
					mysqli_select_db($link, "bookreviews") or die("Could not select the database.");
					
					print "<form method=\"POST\" action=\"addReview2.php\">
								...
								<br>
								Rating: <input type=\"radio\" name=\"rating\" value=\"5 Stars\"> 5 Stars
